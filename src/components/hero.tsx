...
export default function Hero({anchor}:HeroI) {
  ...
  return (
    <div className="flex justify-center sectionScrollMarginTop snap-start mt-16 bg-slate-300 w-full bg-grasshopper" id={anchor}>
      <div className="flex flex-col-reverse md:flex-row w-11/12 mt-4">
        <div className="w-full md:w-1/2 mt-20 md:mt-0 mb-8">
          <img src="/img/Michael_Grills_Product_Managment_Hero.png"></img>
        </div>
        <div className="flex flex-col w-full md:w-2/3 text-slate-100 bg-slate-500 pl-2 font-heading text-midnightblue md:mt-24 lg:mt-36 xl:mt-48">
